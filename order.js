    ...
    init : function () {
      ...
      for (let id in cart.products) {
       ...
       let teaItem = `
        ...
        <div class="card rounded-0 border-0 col-md-4" >
        <img src=${p.img} class="card-img-top" alt="...">
        <div class="card-body">
          <ul class="list-group list-group-flush">
            <li class="list-group-item text-center font-weight-bold  tea-name mb-3 d-flex align-items-center justify-content-center pb-1">${p.name}</li>
            <li class="list-group-item tea-props font-weight-bold h6 mb-3">$${p.price / 100} / 1 oz</li>
            <li class="list-group-item tea-props font-weight-bold h6 mb-3">Caffeine Level: ${p.caffeineLvl}</li>
            <li class="list-group-item mx-auto">
              <button class="py-2 px-4 checkout-btn" data-id=${id}>Checkout</button>
        ...
        let greenDiv = document.querySelector('#green .row');
        let blackDiv = document.querySelector('#black .row');
        let mixedDiv = document.querySelector('#mixed .row');

        
        if (p.color === "black"){
          blackDiv.insertAdjacentHTML("afterbegin", teaItem);
        }
        if (p.color === "green"){
          greenDiv.insertAdjacentHTML("afterbegin", teaItem);
        }
        if (p.color === "mixed"){
          mixedDiv.insertAdjacentHTML("afterbegin", teaItem);
        }

        let checkoutBtn = document.querySelectorAll(".checkout-btn");
        checkoutBtn.forEach(btn => {
          
          btn.addEventListener("click", cart.add);
        })
      }
        ...
        for (let id in cart.items) {
          ...
          <div class="in-cart my-4">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <img src=${p.img} alt="" style="height: 150px; width: 150px;" class="mx-auto d-block">
                </div>
                <div class="col-md-8">
